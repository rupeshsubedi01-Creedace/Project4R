    ...
    for arg do
        if
            case $arg in                                #(
              ...
              /?*)  t=${arg#/} t=/${t%%/*}             # is this a POSIX filepath?
                    [ -e "$t" ] ;; #(
              *)    false ;;
            esac
        then
        ...
        # temporary unset variables.  Note that if there are zero args, creating
        # an extra positional parameter does not have effects.
